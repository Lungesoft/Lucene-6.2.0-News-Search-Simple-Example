...
public class UpdatedRankingEvaluation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String request : getManualEvaluationData().keySet()) {
            oldData.add(getManualEvaluationData().get(request));
        }
        ...
        for (String request : getManualEvaluationData().keySet()) {
            ...
            List<Integer> relDocs = getManualEvaluationData().get(request);
    ...
    private static Map<String, List<Integer>> getManualEvaluationData() {
